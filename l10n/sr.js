OC.L10N.register(
    ...
    "Map directions (by OSRM)" : "Упутства на мапи (од OSRM)",
    ...
    "An administrator has disabled the OpenStreetMap Unified Search provider" : "Администратор је искључио OpenStreetMap пружаоца Обједињене претраге",
    ...
    "Routing profile" : "Профил рутирања",
    ...
    "Click on the map to add waypoints. Click on waypoints to delete them. Waypoints can be dragged." : "Кликните на мапу да додате успутне тачке. Кликните на успутне тачке да их обришете. Успутне тачке могу да се повлаче.",
    "Click on the map to set the start location" : "Кликните на мапу да поставите почетну локацију",
    "Click on the map to add a waypoint" : "Кликните на мапу да додате успутну тачку",
    "Distance: {distance}" : "Растојање: {distance}",
    "Duration: {duration}" : "Трајање: {duration}",
    "Link type" : "Тип линка",
    "Generate direction link" : "Генериши линк за смер",
    "Link could not be copied to clipboard" : "Линк не може да се копира у клипборд",
    "Cancel edition" : "Откажи уређивање",
    "Edit route" : "Уреди руту",
