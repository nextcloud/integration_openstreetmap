OC.L10N.register(
    ...
    "Map directions (by OSRM)" : "Bideratzea mapan (OSRM-ren bidez)",
    ...
    "An administrator has disabled the OpenStreetMap Unified Search provider" : "Administratzailea batek desaktibatu du OpenStreetMapen bilaketa bateratuen hornitzailea",
    ...
    "Routing profile" : "Bideratze-profila",
    ...
    "Click on the map to add waypoints. Click on waypoints to delete them. Waypoints can be dragged." : "Egin klik mapan bide-puntuak gehitzeko. Egin klik bide puntuetan horiek ezabatzeko. Bide-puntuak arrastatu daitezke.",
    "Click on the map to set the start location" : "Egin klik mapan abiapuntua ezartzeko",
    "Click on the map to add a waypoint" : "Egin klik mapan bide-puntu bat gehitzeko",
    "Distance: {distance}" : "Distantzia: {distance}",
    "Duration: {duration}" : "Iraupena: {duration}",
    "Link type" : "Esteka mota",
    "Generate direction link" : "Sortu norabidearen esteka",
    "Link could not be copied to clipboard" : "Ezin izan da esteka arbelean kopiatu",
    "Cancel edition" : "Utzi edizioa",
    "Edit route" : "Editatu ibilbidea",
