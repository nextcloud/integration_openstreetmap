OC.L10N.register(
    ...
    "Map directions (by OSRM)" : "Direções do mapa (por OSRM)",
    ...
    "Proxy map tiles/vectors requests via Nextcloud" : "Solicitação de vetores/blocos de mapa proxy via Nextcloud",
    ...
    "Generate direction link" : "Gerar link de direção",
    "Search with Nominatim to get an OpenStreetMap link" : "Pesquise com o Nominatim para obter um link do OpenStreetMap",
    "Click on the map to add waypoints. Click on waypoints to delete them. Waypoints can be dragged." : "Clique no mapa para adicionar pontos de referência. Clique neles para excluí-los e também podem ser arrastados.",
    ...
    "Copy direction link" : "Copiar link de direção",
